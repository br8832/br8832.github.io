...
class Projects extends React.Component{
    constructor (props){
        ...
        this.projects = [
            ...
            {name:"Speech-to-Text Bot", path: Speech_to_Text, repository: "https://github.com/CSUN-ACM/Speech-To-Text", date:"JANUARY 2020 - MAY 2020 ", description: "Utilizing Python and its various libraries, we created a bot for converting a person’s speech to text. I helped in creating the model for the bot, testing it with PyAudio, and recording interesting trends and data in Excel.  "},
